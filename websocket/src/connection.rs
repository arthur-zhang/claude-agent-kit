...
use crate::message::{ConnectionId, ServerMessage};
...
mod tests {
    ...
    async fn test_send_to_connection() {
        ...
        let msg = ServerMessage::notification(serde_json::json!({"test": "data"}));
    ...
    async fn test_broadcast() {
        ...
        let msg = ServerMessage::notification(serde_json::json!({"broadcast": "test"}));
